    ...
    <div className="min-h-screen bg-midnight-900 flex items-center justify-center px-6">
      <motion.div initial={{ opacity:0,y:20 }} animate={{ opacity:1,y:0 }}
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-warm-300 mt-2">Welcome back</p>
        </div>
          ...
          {!sent ? (
            <>
              <form onSubmit={handleMagicLink} className="space-y-4">
                ...
                <button type="submit"
                  className="w-full py-3 bg-amber-400 text-midnight-900 font-semibold rounded-xl
              ...
              <button className="w-full py-3 border border-warm-400/20 text-warm-200 rounded-xl
                               hover:border-amber-400/30 hover:text-amber-300 transition-all flex items-center justify-center gap-3">
